...
## It is useful for saving computational effort of obtaining the inverse of a matrix for which the inverse was previously calculated
...
## In this function, we define a method to get the matrix itself, get its inverse, or set the value of the matrix or its inverse.
...
## This function will try to see if the inverse of a matrix of the type we previously defined has an inverse
## If it finds the inverse has been calculated, it will return the inverse
## If no inverse is found, the inverse is calculated with the solve() function, set in our special "matrix"
## Lastly, the function returns the inverse
